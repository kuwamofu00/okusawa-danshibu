...
<head>
    ...
    <title>okusawabu-history</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">
    <link rel="stylesheet" type="text/css" href="okusawa.css">
</head>
<body>
    <header>
  ...
  <section class="jumbotron text-center">
    <div class="container">
      ...
      <p class="lead text-muted text-left" >
        ...
        </br><p class="lead-text-muted-o">〈注意事項〉以下の行為はご遠慮願います。
          ...
          <div class="card mb-4 shadow-sm text-white bg-primary" >
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary bg-white">View</button>
...
この2日後の1月4日付の聖教新聞に、第1回となる「随筆　新・人間革命」が掲載されました。
...
『人間革命』では、戸田先生の心の中だけに「黎明」があったと述べられています。つまり、
戸田先生お一人の心から始まった「地涌の菩薩」としての自覚と実践が、弟子・山本伸一に受け継がれ、
旭日の勢いで、世界へ広宣流布が広がっていったのです。</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
...
恩師の「征くんだ」との叫びは、池田先生にとって戸田先生と歩む「平和への遠征」の原点にほかならなかったのです。
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a class="btn btn-sm btn-outline-secondary" href="https://mega.nz/file/FxsGAJ4C#I276K7qSu5Cnn2scd3-osyXA0Yb9M0wbM05arRaP8EI" target="_blank">見る</a>
                  <!--<button type="button" class="btn btn-sm btn-outline-secondary">Edit</button>
                  -->
...
<!--5................................................................................................................--> 
        <div class="col-md-4">
          <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
              <p class="card-text">
                    前回の続き</br>伸一が当面の大テーマとしていたのが、本陣・東京の再構築だった。１月に新宿、練馬の友を激励したあと、２月に入ると、まず中野へ。参加した中野の青年たちに、30年間、毎年集うとともに、メンバーで「中野兄弟会」を結成することを提案。
伸一の足跡は、２、３月にかけて、港、渋谷、世田谷、千代田、杉並、目黒、さらに多摩方面の第２東京本部へと及び、地域ごとの特色を大切にした激励を重ねる。ここに「東京革命」の烽火が燃え上がった。
日本の政治・経済の中心である首都・東京で、難攻不落の大城を構築し、世界の立正安国の基盤を築く戦いが、伸一の手で着々と進められていったのである。</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
...
<div class="col-md-4">
          <div class="card mb-4 shadow-sm">
            <div class="bd-placeholder-img card-img-top bg-secondary d-flex align-items-center">
              <span class="d-block text-center" style="width: 100%;">
              <a>奥沢部第6回研鑽会</br>新人間革命 第1巻 『新世界』</br>奥沢部と本部ヤングによる合同教学研鑽会</br></a></span>  
            </div>
            <div class="card-body">
              <p class="card-text">
              ※今回は合同研鑽会①、②の2部構成
        ...
        <div class="col-md-4">
          <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a class="btn btn-sm btn-outline-secondary" href="" target="_blank">見る</a>
